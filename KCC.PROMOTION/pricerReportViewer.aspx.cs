namespace KCC.PROMOTION
{
    ...
    public partial class pricerReportViewer : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e) {
            ...
            if (dtTransactionDetail.Rows[0]["APPROVED_DATE"].ToString() == string.Empty)
            {
                this.rpt.SetParameterValue("param_approved_date", string.Empty);
            }
            else
            {
                this.rpt.SetParameterValue("param_approved_date", Convert.ToDateTime(dtTransactionDetail.Rows[0]["SUBMITTED_DATE"]).ToString("dd-MMM-yyyy").ToUpper());
            }
