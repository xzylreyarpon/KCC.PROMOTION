<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="SellingAreaCreate.aspx.cs" Inherits="KCC.PROMOTION.SellingAreaCreate" %>
        ...
        <div id="SellingAreaBody" style="height:100%" class="SellingMainBody">
                        ...
                        <td width="50%">
                            <table class="filterlabel" cellpadding="0">
                             ...
                             <table id="tblDates" cellpadding="0">
                                <tr>
                                    <td>
                                         <input id='txtStartDate'  type="text"  class="inputs dateSelection" placeholder="Start Date" style="display: none;" readonly="readonly" />
                                    </td>
                                    <td>
                                         <input  id='txtEndDate' type="text" class="inputs dateSelection" placeholder="End Date" style="display: none;" readonly="readonly" />
                                    </td>
                                    <%--Remove this button to add new dates--%>
                                    <%--<td>
            ...
            <div style="height:85%; ">
                                ...
                                <table width="100%" cellpadding="0" cellspacing="0" >
                                   <tr>
                                      <td style="text-align:left; width:30%;">
                                       ...
                                       <td  style="text-align:left; width:30%; font-size:15px; padding-top:6px;">
                ...
                <div id="divFreeList" style="width:100%;">
                    <div style="margin-top:20px;font-size:15px;box-sizing:border-box;padding:10px 15px;background-color:#eaeaea;border-color:#ddd;color:#333;">
                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0" >
                                       <tr>
                                          <td style="text-align:left;width:30%;">
                                           ...
                                           <td  style="text-align:left;padding-top:6px;font-size:15px;width:30%;">
                                               <span>Total Items:</span>
