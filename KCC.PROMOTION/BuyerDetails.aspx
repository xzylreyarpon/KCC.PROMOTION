<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="BuyerDetails.aspx.cs" Inherits="KCC.PROMOTION.BuyerDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="Outline" class="SellingOutline" style="height:100%; width:101%;">
                        ...
                        <td width="50%">
                            <table class="filterlabel" cellpadding="0">
                                <tr>
                                    ...
                                    <td>
                                        <textarea id="txtPromoDescription" rows="3" maxlength="110" class="inputs" style="height: 20px; min-height: 20px; max-height:80px; width: 300px;  max-width: 300px; min-width: 300px; wrap="hard" "></textarea>                                
                                    </td>                                
                                </tr>
                                 <tr>
                                    <td>
            ...
            <div style="height:85%; ">
                <table width="100%" cellpadding="0" cellspacing="0">
                        ...
                        <td colspan="3">
                          <%-- Row Editor body --%>
                             ...
                             <div style="height:535px;">
                               ...
                               <%--start tbl Items--%>
                                 <table id="tblItems" style="text-align:center" class="display" cellspacing="0" width="95%">
                                    <thead>
                                        <tr>
                             ...
                             <div id="Div3" class="gridfoot" style="height:38px;position: relative;">  
                                <table width="100%" cellpadding="0" cellspacing="0" >
                                   <tr>
                                        ...
                                        <td style="text-align:left; padding-top:6px; width:50%; font-size:15px;">
                                        ...
                                        <td style="text-align:right; width:30%;">
                                            <input id="btnBack" type="button" value="Back" class="button-primary" tabindex='9' />
                                             <input id="btnRemove" type="button" style="display:none;" value="Remove" class="button-primary" tabindex='11' />
                 ...
                 <div id="divFreeList" style="width:100%;">
                    <div style="margin-top:5px;font-size:15px;box-sizing:border-box;padding:10px 15px;background-color:#eaeaea;border-color:#ddd;color:#333;">
                            ...
                            <td colspan="3">
                                 <div style="height:390px;">  
                                     <table id="tblItemsFreeList" style="text-align:center" class="display" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>     
                                                <th><input id="chkFreeSet" type="checkbox" /></th>                                          
                                                <th>ORIN</th>
                                                <th>BARCODE</th>
                                                <th>VPN</th>
                                                <th>ITEM DESCRIPTION</th>
                                 ...
                                 <div id="Div2" class="gridfoot" style="height:38px;">  
                                    <table width="100%" cellpadding="0" cellspacing="0" >
                                       <tr>
                                           <td style="text-align:right; width:40%; font-size:15px; padding-top:10px;">
                                                <span>Total Items:</span>
                                                <span id="total_freeList_items">0</span>
                                           </td>
                                           <td style="text-align:right; width:30%;">                                           
                                             <input id="btnRemoveFreeList" type="button" style="display:none;" value="Remove" class="button-primary" tabindex='11' />
                                        </td>                           
                                       </tr>                                        
                                    </table> 
                                 </div>
    ...
    <div id="PopUpSetMultipleOutline"  class="modalPage" >
        ...
        <div id= "PopSetMultipleContainer" class="modalContainer" style="height: 130px;width:200px; margin: 230px 34% 15%;">
